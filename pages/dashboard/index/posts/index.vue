<template>
  <AppPageContainer
    title="Posts"
    description="A demo page to showcase how subscriptions work"
  >
    <div class="mb-4">
      <UButton
        label="Create post"
    ...
    >
      ...
      <li>
        If user is on Free plan/Trial/No subscription, they will see a button to
        create a checkout link, they can create 1 post.
      </li>
  ...
  try {
    ...
    if (currentPost.value) {
      ...
      const updatedPost = await $fetch(
        `/api/demo/posts/${currentPost.value.id}`,
        {
          method: "PATCH",
          body: event.data,
        },
